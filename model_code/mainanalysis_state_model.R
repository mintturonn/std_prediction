...
# main analysis
fit_main <- stan(
  file = "model_code/mainanalysis_state_model.stan",
  data = ctgc_data_main,
  init = init_fun,
  chains = 4,
  iter = 6000,
...
rstan::check_hmc_diagnostics(fit_main)

summary(fit_main, pars = c("check_ct", "check_gc","te","te_rate","p_ct_f","p_gc_f"))
summary(fit_main, pars = c("check_ct"))
summary(fit_main, pars = c("check_gc"))

summary(fit_main, pars = c("i_ct_f_RR", "i_gc_f_RR"))$summary
